    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4 py-24 text-center">
        <img 
          ...
          className="mx-auto mb-8 w-48 h-48 object-contain animate-in fade-in duration-1000"
        />
        <h1 className="mb-6 text-4xl font-bold text-primary-foreground md:text-6xl animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-200">
          Fixing Suspension Problems the Right Way — For Over 25 Years
        </h1>
        <p className="mb-12 text-xl text-primary-foreground/90 md:text-2xl max-w-3xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-300">
